...
import com.kreggscode.confuciusquotes.viewmodel.ChatMessage
...
fun PremiumChatHeader(
    ...
    GlassmorphicCard(
        ...
        Row(
            ...
            // Confucius Avatar with animation
            Box(
                modifier = Modifier
                    .size(45.dp)
                    .clip(CircleShape)
...
@Composable
fun ConfuciusThinkingIndicator() {
