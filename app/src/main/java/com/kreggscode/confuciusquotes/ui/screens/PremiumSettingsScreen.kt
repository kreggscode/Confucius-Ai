                    ...
                    onShareClick = {
                        try {
                            val shareIntent = Intent(Intent.ACTION_SEND).apply {
                                type = "text/plain"
                                putExtra(Intent.EXTRA_SUBJECT, "Confucius - Insights & Wisdom")
                                putExtra(Intent.EXTRA_TEXT, "Check out Confucius - Insights & Wisdom app! Get inspired by Confucius's wisdom daily.\n\nhttps://play.google.com/store/apps/details?id=com.kreggscode.confuciusquotes")
                            }
                ...
                RateAppSection(
                    onRateClick = {
                        try {
                            ...
                            val playStoreIntent = Intent(Intent.ACTION_VIEW, Uri.parse("market://details?id=com.kreggscode.confuciusquotes"))
                            playStoreIntent.addFlags(Intent.FLAG_ACTIVITY_NEW_TASK)
                            context.startActivity(playStoreIntent)
                        } catch (e: Exception) {
                            // If Play Store app is not available, open in browser
                            try {
                                val browserIntent = Intent(Intent.ACTION_VIEW, Uri.parse("https://play.google.com/store/apps/details?id=com.kreggscode.confuciusquotes"))
        ...
        Row(
            ...
            Row(
                ...
                Column {
                    ...
                    Text(
                        "Share Confucius wisdom with friends",
                        style = MaterialTheme.typography.bodySmall,
                        color = PremiumColors.CyberBlue
                    )
                }
                    ...
                    onClick = {
                        try {
                            val emailIntent = Intent(Intent.ACTION_SENDTO).apply {
                                ...
                                putExtra(Intent.EXTRA_SUBJECT, "Confucius App Feedback")
                            }
        ...
        Column(
            ...
            SettingRow(
                ...
                onClick = {
                    val emailIntent = Intent(Intent.ACTION_SENDTO).apply {
                        data = Uri.parse("mailto:kreg9da@gmail.com")
                        putExtra(Intent.EXTRA_SUBJECT, "Confucius App - Bug Report")
            ...
            SettingRow(
                ...
                onClick = {
                    val emailIntent = Intent(Intent.ACTION_SENDTO).apply {
                        data = Uri.parse("mailto:kreg9da@gmail.com")
                        putExtra(Intent.EXTRA_SUBJECT, "Confucius App - Support Request")
                    }
                    context.startActivity(emailIntent)
                }
            )
