    ...
    Box(
        ...
        Scaffold(
            ...
            if (isLoading) {
                ...
                item {
                    Text(
                        "🌟 Confucius-Inspired Affirmations",
...
fun BreathingExerciseCard() {
    ...
    GlassmorphicCard(
        ...
        Column(
            ...
            Text(
                "Take a moment to center yourself with Confucius's wisdom",
...
fun generateConfuciusAffirmations(): List<Affirmation> {
    return listOf(
        Affirmation(
            1,
        ...
        Affirmation(
            2,
            "Like Confucius, I question everything and seek deeper understanding.",
            "Wisdom",
            "🤔",
