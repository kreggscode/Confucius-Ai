...
import com.kreggscode.confuciusquotes.model.Quote
        ...
        Column(
            ...
            Text(
                text = "This quote from \"${quote.Work}\" was written during ${quote.Year}, " +
                        "a period when Confucius was ${getHistoricalContext(quote.Year)}. " +
...
fun getAIInsight(quote: Quote): String {
    val insights = listOf(
        "This quote reflects Confucius's belief that ${quote.Category.lowercase()} is fundamental to human progress. The emphasis on ${quote.Quote.split(" ").take(3).joinToString(" ")} suggests a deep understanding of how innovation emerges from questioning established norms.",
        "Confucius's perspective here challenges us to reconsider our approach to ${quote.Category.lowercase()}. Written in ${quote.Year}, this wisdom remains remarkably relevant to modern challenges in science and society.",
        "The philosophical depth in this quote demonstrates Confucius's role not just as a scientist, but as a thinker who understood the interconnection between ${quote.Category.lowercase()} and human experience.",
        "This insight from ${quote.Work} showcases Confucius's unique ability to distill complex ideas into accessible wisdom. The focus on ${quote.Category.lowercase()} reveals his holistic approach to understanding reality."
    )
...
fun generateReflectionPrompts(quote: Quote): List<String> {
    return listOf(
        ...
        "How might Confucius's perspective change your approach to problem-solving?",
